...
#Google books Api search access with Python. Anonymous Access is rate limited by google. An alternative is the https://github.com/google/gdata-python-client
